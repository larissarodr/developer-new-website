      ...
      <footer>
        ...
        <div className="footerInfo">
          ...
          <div className="contact-footer">
            <h3>Contato</h3>
            <p><FiPhone size={14} color="#000"/> Vendas: (47) 3028-2711</p>
            <p><FiPhone size={14} color="#000"/> Suporte: (47) 3029-2771</p>
            <p><FiAtSign size={14} color="#000"/> developer@developer.inf.br</p>
            <p>Joinville, SC</p>
          </div>
        </div>
